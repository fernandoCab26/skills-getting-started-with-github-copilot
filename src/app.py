...
activities = {
    ...
    "Art Studio": {
        "description": "Open studio time for painting, drawing, and mixed media projects",
    ...
    "Debate Team": {
        "description": "Practice formal debate, public speaking, and tournament preparation",
